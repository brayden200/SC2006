...
describe('LtaDataMallService', () => {
                ...
                plugTypes: [
                  {
                    ...
                    priceType: '$/kWh',
                    evIds: [
                      { evCpId: 'A-001', status: 1 },
                      { evCpId: 'A-002', status: 0 },
                    ],
                  },
                ],
              },
    ...
    const station = service.normalizePayload([
      {
        ...
        chargingPoints: [
          {
            plugTypes: [
              { plugType: 'CCS2', chargingSpeed: 50, price: 0, priceType: '$/kWh', evIds: [{ status: 1 }] },
            ],
          },
        ],
      },
  ...
  it('supports the live EVCBatch envelope and field variants', () => {
    ...
    const station = service.normalizePayload({
      ...
      evLocationsData: [
        {
          address: '2 Live Road Singapore 654321',
          postalCode: '654321',
          latitude: '1.31',
          longtitude: '103.81',
          name: 'Live Hub',
          chargingPoints: [
            {
              ...
              plugTypes: [
                ...
                },
                {
                  ...
                  price: '',
                  priceType: '',
                  evIds: [{ evCpId: 'R123456A-002', status: 0 }],
                },
              ],
            },
          ],
